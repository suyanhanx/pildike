  ...
  createClass(Uploader, [{
    ...
    value: function installed() {
      ...
      ["dragenter", "dragover", "dragleave", "drop"].forEach(function (eventName) {
        _this3.addEventListener(eventName, _this3.preventDefault, false);
      });

      ["drop"].forEach(function (eventName) {
        _this3.addEventListener(eventName, _this3.handleDrop, false);
      });

      this.ondragenter = function () {
        return _this3.classList.add("highlight");
      };
      this.ondragleave = function () {
        return _this3.classList.remove("highlight");
      };
      this.ondragend = function () {
        return _this3.classList.remove("highlight");
      };
      this.onclick = function () {
        return _this3.shadowRoot.querySelector("#file_uploader").click();
      };
    ...
    value: function inputUpload(event) {
      ...
      [].concat(toConsumableArray(files)).forEach(function (file) {
        return _this5.previewFile(file);
      });
    }
  }, {
    key: "previewFile",
    ...
    key: "removeImage",
    value: function removeImage(image, event) {
      this.preventDefault(event);
    ...
    value: function render$$1() {
      ...
      return Omi.h(
          ...
          this.images.map(function (img) {
            return Omi.h(
              ...
              Omi.h(
                "span",
                {
                  onclick: _this7.removeImage.bind(_this7, img),
                  className: "delete-image"
                },
                "\xD7"
              ),
              Omi.h("img", { src: img.result }),
              Omi.h(
                "span",
                null,
                img.name
        ...
        Omi.h(
          "div",
          { id: "ready-button", onclick: this.ready },
          "Done"
        )
      );
    }
