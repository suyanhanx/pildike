...
var Uploader = function (_WeElement) {
  inherits(Uploader, _WeElement);
  ...
  createClass(Uploader, [{
    ...
    value: function installed() {
      ...
      ["dragenter", "dragover", "dragleave", "drop"].forEach(function (eventName) {
        _this2.addEventListener(eventName, _this2.preventDefault, false);
      });

      ["drop"].forEach(function (eventName) {
        _this2.addEventListener(eventName, _this2.handleDrop, false);
      });

      this.ondragenter = function () {
        return _this2.classList.add("highlight");
      };
      this.ondragleave = function () {
        return _this2.classList.remove("highlight");
      };
      this.ondragend = function () {
        return _this2.classList.remove("highlight");
      };
      this.onclick = function () {
        return _this2.shadowRoot.querySelector("#file_uploader").click();
      };
      this.shadowRoot.querySelector("#file_uploader").addEventListener("change", this.inputUpload, false);
    }
  }, {
    key: "applyImages",
    value: function applyImages(event) {
    ...
    value: function handleDrop(event) {
      ...
      [].concat(toConsumableArray(files)).forEach(function (file) {
        return _this3.previewFile(file);
      });
      this.classList.remove("highlight");
    }
  }, {
    key: "inputUpload",
    value: function inputUpload(event) {
      var _this4 = this;

      var files = event.target.files;
      [].concat(toConsumableArray(files)).forEach(function (file) {
        return _this4.previewFile(file);
      });
    }
  }, {
    key: "previewFile",
    value: function previewFile(file) {
      ...
      reader.onloadend = function () {
        _this5.images.push(reader.result);
        _this5.update();
      };
    }
  }, {
    ...
    value: function render$$1() {
      return Omi.h(
        "div",
        { id: "upload-container", "class": this.images.length > 0 ? "filled" : "empty" },
        Omi.h("input", {
          id: "file_uploader",
          type: "file",
          style: "display:none;",
